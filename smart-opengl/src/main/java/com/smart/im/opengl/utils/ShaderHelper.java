...
public class ShaderHelper {
    ...
    public static int buildProgramFromResource(Context context, int vertexShaderSource, int fragmentShaderSource) {
        ...
        String vertexString = TxtResourceReader.readTxtFileFromResource(context, vertexShaderSource);
        String textureString = TxtResourceReader.readTxtFileFromResource(context, fragmentShaderSource);
    ...
    public static int buildProgramFromAssetFile(Context context, String vertexFileName, String fragmentFileName) {
        String vertexString = TxtResourceReader.readTxtFileFromAsset(context, vertexFileName);
        String fragmentString = TxtResourceReader.readTxtFileFromAsset(context, fragmentFileName);
